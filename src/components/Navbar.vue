<template>
  ...
  <v-navigation-drawer v-model="drawer" width="300">
    <v-list style="position: absolute" flat width="100%">
      ...
      >
        <template v-slot:prepend>
          <v-avatar class="ml-4" size="x-large" v-html="logo[model.name]" />
        </template>
